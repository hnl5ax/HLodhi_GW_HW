...
usentence_cont = len(sentence_split)
words_per_sentence = []
...
output = (
   ...
   f"Approximate Sentence Count: {usentence_cont}\n"
   f"Approximate Letter Count (per word) {avg_letter_count:.2f}\n"
   f"Average Sentence Length (in words): {avg_sentence_len:.2f}\n")
